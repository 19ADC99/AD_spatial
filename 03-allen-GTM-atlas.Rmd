...
Let's import the Atlas and run some dimensionality reduction on it, since the UMAP is available but not the PCA.

```{r, echo=FALSE, eval=FALSE}
# import
allen_MTG_reference = readRDS("/home/andrea/Dump/AD_spatial/allen_MTG_reference.rds")
...
```{r, fig.cap="UMAP Allen MTG reference", fig.height=9,  warning=FALSE, message=FALSE}
